...
/*
	---------BUGS------------------
	4. вопрос 3.4 не существенно
	5. вопрос 3.6 не правильно записано множество ребер - сделать как в лекциях
	6. сделать интерфейс
	---------TEST--THIS------------
	1. Петли не должны быть в дополнении (из-за этого ошибка при построении формулы) *FIXED*
	2. В матрице смежности петля это двойка *FIXED*
	3. (2.1.4) все вершины и периферийные и центры *FIXED*
	-------------------------------
*/
